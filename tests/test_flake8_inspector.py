...
from review.reviewers.utils.issues_filter import filter_low_metric_issues
from tests.conftest import gather_issues_test_info, IssuesTestInfo, use_file_metadata
from . import PYTHON_DATA_FOLDER
...
def test_file_with_issues(file_name: str, n_issues: int):
    ...
    with use_file_metadata(path_to_file) as file_metadata:
        ...
        issues = filter_low_metric_issues(issues, Language.PYTHON)
