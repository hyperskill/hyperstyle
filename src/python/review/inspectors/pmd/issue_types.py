...
PMD_RULE_TO_ISSUE_TYPE: Dict[str, IssueType] = {
    ...
    'PrematureDeclaration': IssueType.CODE_STYLE,
    'RemoteInterfaceNamingConvention': IssueType.CODE_STYLE,
    'RemoteSessionInterfaceNamingConvention': IssueType.CODE_STYLE,
    'ShortClassName': IssueType.CODE_STYLE,
    'ShortMethodName': IssueType.CODE_STYLE,
    'ShortVariable': IssueType.CODE_STYLE,
    'SuspiciousConstantFieldName': IssueType.CODE_STYLE,
    'TooManyStaticImports': IssueType.CODE_STYLE,
    'UnnecessaryAnnotationValueElement': IssueType.CODE_STYLE,
    ...
    'AvoidLiteralsInIfCondition': IssueType.ERROR_PRONE,
