...
def write_dataframe_to_csv(csv_file_path: Union[str, Path], df: pd.DataFrame) -> None:
    # Get error with this encoding=ENCODING on several fragments:
    # "UnicodeEncodeError: 'latin-1' codec can't encode character '\u1ea3' in position 41: ordinal not in range(256)
