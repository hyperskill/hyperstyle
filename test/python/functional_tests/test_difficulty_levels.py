...
def _get_output_json(
    local_command: LocalCommandBuilder, file_path: str, history: str | None = None
) -> dict[str, object]:
    local_command_path = DATA_PATH / "difficulty_levels" / file_path

    local_command.verbosity = 0
    local_command.format = "json"
    local_command.path = local_command_path
    ...
    "issues": [
        {
            ...
            "line": "class BadClass:",
            "line_number": 4,
            "text": get_cohesion_tip().format(80),
        },
    ],
}
...
def test_difficulty_levels(
    local_command: LocalCommandBuilder, file: str, expected_json: dict[str, object]
) -> None:
