...
JSON_FORMAT_SCHEMA_TEST_DATA = [
    ...
    (
        False,
        True,
        _get_old_format_schema(QUALITY_BY_DIFFICULTY_SCHEMA, INFLUENCE_ON_PENALTY_BY_DIFFICULTY_SCHEMA),
    ),
    (
        True,
        True,
        _get_new_format_schema(QUALITY_BY_DIFFICULTY_SCHEMA, INFLUENCE_ON_PENALTY_BY_DIFFICULTY_SCHEMA),
    ),
]
