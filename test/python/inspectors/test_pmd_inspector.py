...
FILE_NAME_AND_ISSUES = [
    ...
    (
        ...
        [
            CodeIssue(
                origin_class="AvoidDuplicateLiterals",
            ...
            CodeIssue(
                origin_class="UncommentedEmptyMethodBody",
                type=IssueType.BEST_PRACTICES,
            ...
            CodeIssue(
                origin_class="UnusedLocalVariable",
                type=IssueType.BEST_PRACTICES,
            ...
            CodeIssue(
                origin_class="UnusedPrivateMethod",
                type=IssueType.BEST_PRACTICES,
    ...
    (
        ...
        [
            CodeIssue(
                origin_class="CompareObjectsWithEquals",
            ...
            CodeIssue(
                origin_class="SuspiciousEqualsMethodName",
                type=IssueType.ERROR_PRONE,
            ...
            CodeIssue(
                origin_class="UselessParentheses",
