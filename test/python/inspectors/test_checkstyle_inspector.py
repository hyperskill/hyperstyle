...
FILE_NAME_AND_ISSUES = [
    ...
    (
        ...
        [
            CodeIssue(
                origin_class="MultipleStringLiteralsCheck",
            ...
            CodeIssue(
                origin_class="WhitespaceAroundCheck",
    ...
    (
        ...
        [
            ...
            CodeIssue(
                origin_class="CovariantEqualsCheck",
                type=IssueType.ERROR_PRONE,
    ...
    (
        ...
        [
            CodeIssue(
                origin_class="OneStatementPerLineCheck",
                type=IssueType.CODE_STYLE,
            ...
            CodeIssue(
                origin_class="WhitespaceAfterCheck",
                type=IssueType.CODE_STYLE,
                description="',' is not followed by whitespace.",
                file_path=Path("/home/user/Desktop/some_project/main2.java"),
                line_no=136,
...
FILE_NAMES_AND_N_ISSUES_INFO = [
    ("test_simple_valid_program.java", IssuesTestInfo(n_func_len=1, n_cc=1)),
    ("test_invalid_naming.java", IssuesTestInfo(n_code_style=14, n_func_len=3, n_cc=3)),
    ("test_unused_imports.java", IssuesTestInfo(n_best_practices=5, n_func_len=1, n_cc=1)),
    (
    ...
    ("test_too_long_method.java", IssuesTestInfo(n_func_len=3, n_cc=3, n_info=3)),
    ("test_cyclomatic_complexity.java", IssuesTestInfo(n_func_len=5, n_cc=5, n_bool_expr_len=1, n_info=8)),
    (
