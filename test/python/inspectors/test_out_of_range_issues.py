...
def test_out_of_range_issues_when_some_out_of_range_issues() -> None:
    ...
    assert filter_out_of_range_issues(issues, start_line=4, end_line=8) == [issues[3], issues[4]]
...
def test_out_of_range_issues_when_the_same_borders() -> None:
    ...
    assert filter_out_of_range_issues(first_line_issues, start_line=1, end_line=1) == first_line_issues

    assert filter_out_of_range_issues(first_line_issues, start_line=2, end_line=2) == []
