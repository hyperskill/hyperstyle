...
from review.inspectors.issue import (
    BaseIssue, ChildrenNumberIssue, ClassResponseIssue, CodeIssue, CohesionIssue,
    CouplingIssue, InheritanceIssue, IssueType, MethodNumberIssue, WeightedMethodIssue
)
from review.inspectors.tips import (
    get_child_number_tip, get_class_coupling_tip,
    get_class_response_tip, get_cohesion_tip,
    get_inheritance_depth_tip, get_method_number_tip,
