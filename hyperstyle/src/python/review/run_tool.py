...
def configure_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        RunToolArgument.LANG.value.long_name,
    ...
    parser.add_argument(
        RunToolArgument.PATH.value.long_name,
    ...
    parser.add_argument(
        RunToolArgument.NEW_FORMAT.value.long_name,
        action="store_true",
        help=RunToolArgument.NEW_FORMAT.value.description,
    )

    parser.add_argument(
        RunToolArgument.HISTORY.value.long_name, help=RunToolArgument.HISTORY.value.description, type=str
    )

    parser.add_argument(
        RunToolArgument.WITH_ALL_CATEGORIES.value.long_name,
        help=RunToolArgument.WITH_ALL_CATEGORIES.value.description,
        action="store_true",
    )

    parser.add_argument(
        RunToolArgument.GROUP_BY_DIFFICULTY.value.long_name,
        help=RunToolArgument.GROUP_BY_DIFFICULTY.value.description,
        action="store_true",
    )

    parser.add_argument(
        RunToolArgument.IJ_CONFIG.value.long_name, help=RunToolArgument.IJ_CONFIG.value.description, type=str
    )
...
def main() -> int:
    ...
    try:
        ...
        inspectors_config = {
            ...
            if args.language_version is not None
            else None,
            "n_cpu": n_cpu,
        }
