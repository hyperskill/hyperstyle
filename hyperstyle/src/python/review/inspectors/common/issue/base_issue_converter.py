...
def convert_base_issue(base_issue: BaseIssue, issue_configs_handler: IssueConfigsHandler) -> BaseIssue | None:
    ...
    try:
        ...
        logger.exception(f"{inspector_type.value}: Unable to create a new issue.")
        return None
